    ...
    const blogs = [
      {
        ...
        date: "MARCH 12, 2021",
        url: "2021-3-12-1",
        summary: "其实根本不用折腾扫描码映射键位码之类的，修改一个参数就可以修复这个问题。",
        image: {
      ...
      },
      {
        ...
        url: "2021-2-28-1",
        summary: "通过 SMB 协议可以同时传输视频和视频的字幕，基本上等于一个网盘，可以添加到网络位置像本地磁盘一样操作远程内容。",
        image: {
      ...
      },
      {
        ...
        url: "2021-2-10-1",
        summary: "船新的看番姿势，免去主机的下载/拷贝等操作，直接通过局域网点播你最喜欢的番剧。",
        image: {
      ...
      },
      {
        ...
        url: "2021-1-23-1",
        summary: "Minecraft空岛服务器2周目开服，来康康。",
        image: {
      ...
      },
      {
        ...
        url: "2021-1-21-1",
        summary: "合肥工业大学每日疫情填报新平台自动提交脚本，适用于新平台，挂在你的任意一台计算机/服务器上即可实现定时自动提交。",
        image: {
      ...
      },
      {
        ...
        url: "2020-10-12-1",
        summary: "继续准备数据库的项目，客户端还是想用 JAVA 做。",
        image: {
      ...
      },
      {
        ...
        date: "OCTOBER 7, 2020",
        url: "2020-10-7-1",
        summary: "着手准备数据库的项目，有了大佬的轮子 PyMySQL 用 Python 执行 SQL 语句简直不能再简单了。",
        image: {
      ...
      },
      {
        ...
        date: "OCTOBER 6, 2020",
        url: "2020-10-6-1",
        summary: "关于格式化字符串的细节已经忘得差不多了，回顾一下。",
        image: {
      ...
      },
      {
        ...
        date: "AUGUST 8, 2020",
        url: "2020-8-8-1",
        summary: "需要处理文字的时候，编码问题可能是不可避免的。这一篇主要记录我学习有关 Unicode 的一些细节。",
        image: {
      ...
      },
      {
        ...
        date: "JULY 20, 2020",
        url: "2020-7-20-1",
        summary: "自闭症 Ray_Alto 又又又又开自闭服务器了???",
        image: {
      ...
      },
      {
        ...
        date: "JULY 8, 2020",
        url: "2020-7-8-1",
        summary: "根据我浅显的见解，一些深入底层的操作可以很方便的在 C / C++ 中实现，然而使用 C# 就有些麻烦，所以想到这个奇怪的需求。",
        image: {
      ...
      },
      {
        ...
        date: "JULY 6, 2020",
        url: "2020-7-6-1",
        summary: "有时可能会对跨平台编程有一定需求，而且正巧某些细节在不同操作系统中是不一样的，这种情况就可以通过判断编译器定义的宏来判断操作系统。",
        image: {
      ...
      },
      {
        ...
        date: "JULY 3, 2020",
        url: "2020-7-3-1",
        summary: "想要得到无水印的无情哈拉少还是需要付出一些努力的，整增高，雷霆嘎巴！欧青辣少！",
        image: {
      ...
      },
      {
        ...
        date: "JUNE 2, 2020",
        url: "2020-6-2-1",
        summary: "JAVA Swing 练手小项目，我是没有想到俄罗斯方块里有这么多学问🤔",
        image: {
      ...
      },
      {
        ...
        date: "APRIL 13, 2020",
        url: "2020-4-13-1",
        summary: "是时候告别难看的原生 Power Shell / CMD 了。配置好 Windows Terminal ，既美观又方便，用过的人都说好👍。",
        image: {
      ...
      },
      {
        ...
        date: "APRIL 6, 2020",
        url: "2020-4-6-1",
        summary: "形式与政策的题实在是太多了，简单使用 Python 稍微减少工作量的方法🤫。",
        image: {
      ...
      },
      {
        ...
        date: "APRIL 3, 2020",
        url: "2020-4-3-1",
        summary: "想了解一下CMake实际上做了什么，偶然找到了这里👀。",
        image: {
      ...
      },
      {
        ...
        date: "APRIL 2, 2020",
        url: "2020-4-2-1",
        summary: "最近学习 OpenCV 时需要使用 OpenCV 的链接库，所以看了一下文档，把一些常用参数列在这里。然而直接使用 gcc 链接 OpenCV 的链接库实在太麻烦了，所以想要学习一下 CMake ，使用 CMake 管理源文件，里面也涉及到了好多 gcc 参数相关的内容。",
        image: {
          url: "https://www.rayalto.top/blogs/imgs/gcc.png",
          title: "gcc"
        },
