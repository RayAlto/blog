...
export default class MarkdownArticle extends React.Component {
  ...
  render() {
    ...
    const components = {
      ...
      a: Link,
      hr: Divider,
      h1: ({ level, ...props }) => <Typography variant="h3" gutterBottom {...props} />,
      h2: ({ level, ...props }) => <Typography variant="h4" gutterBotton {...props} />,
      h3: ({ level, ...props }) => <Typography variant="h5" gutterBotton {...props} />,
      h4: ({ level, ...props }) => <Typography variant="h6" gutterBotton {...props} />,
      h5: ({ level, ...props }) => <Typography variant="h6" gutterBotton {...props} />,
      h6: ({ level, ...props }) => <Typography variant="h6" gutterBotton {...props} />,
