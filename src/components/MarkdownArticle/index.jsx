...
class MarkdownArticle extends React.Component {
  ...
  render() {
    ...
    const components = {
      ...
      h1: ({ node, level, ...props }) => <Typography variant="h3" component="h2" gutterBottom {...props} />,
      h2: ({ node, level, ...props }) => <Typography variant="h4" component="h3" gutterBotton {...props} />,
      h3: ({ node, level, ...props }) => <Typography variant="h5" component="h4" gutterBotton {...props} />,
      h4: ({ node, level, ...props }) => <Typography variant="h6" component="h5" gutterBotton {...props} />,
      h5: ({ node, level, ...props }) => <Typography variant="h6" component="h6" gutterBotton {...props} />,
      h6: ({ node, level, ...props }) => <Typography variant="h6" component="h7" gutterBotton {...props} />,
